...
const NotesApp = () => {
  ...
  <form onSubmit={handleSubmit}>  <div className='flex flex-col w-full sm:flex-row'>
        ...
        <h3 className='m-2'>Add Notes:</h3>
            ...
            <input type="text" name="title" placeholder='Enter your Tasks here' onChange={handleInput} value = {Title} className='border-2 outline-none px-4 py-2 m-3'/>
...
>
  Add Task
        ...
        <div className="shownotes  h-screen w-1/2 flex flex-wrap my-0.5 overflow-hidden sm:border-l-2 sm:border-white">
            <div className="note h-60 w-[45%] mx-2 my-2 lg:w-[27%] bg-white text-black">{sbtTitle}</div>
